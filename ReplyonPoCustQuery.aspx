<%@ Page Title="" Language="C#" MasterPageFile="~/AfterLoginEmployeeMasterPage.Master" AutoEventWireup="true" CodeBehind="ReplyonPoCustQuery.aspx.cs" Inherits="CRM_Final_Project.ReplyonPoCustQuery" %>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-ms-4 col-xs-12 body">
                ...
                <div class="form-group">
                     <asp:Label ID="Label1" runat="server" Text="Potantial Customer Query Id" ></asp:Label>
                ...
                <div class="form-group" >
                    <asp:Label ID="Label4" runat="server" Text="Query Type"></asp:Label>
                    <asp:TextBox ID="TextBox4" runat="server" Class="form-control" ReadOnly="True"></asp:TextBox>                    
                  </div>
                 
                 <div class="form-group" >
                    <asp:Label ID="Label5" runat="server" Text="Query"></asp:Label>
                    <asp:TextBox ID="TextBox5" runat="server" Class="form-control" ReadOnly="True"></asp:TextBox>                    
                  </div>
                 <div class="form-group" >
                    <asp:Label ID="Label6" runat="server" Text="Date of Query"></asp:Label>
