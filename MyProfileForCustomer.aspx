<%@ Page Title="" Language="C#" MasterPageFile="~/AfterloginMasterPage.Master" AutoEventWireup="true" CodeBehind="MyProfileForCustomer.aspx.cs" Inherits="CRM_Final_Project.MyProfileForCustomer" %>
     ...
     <div class="container-fluid bg"> 
        <div class="row">
            ...
            <div class="col-md-4 col-ms-4 col-xs-12 box" >
                ...
                <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="~/AfterloginHomePage.aspx" ForeColor="White">Back</asp:LinkButton>
            </div>
            <div class="col-md-4 col-ms-4 col-xs-12" ></div>
        </div>
