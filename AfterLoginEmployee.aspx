<%@ Page Title="" Language="C#" MasterPageFile="~/EmployeeDashboard.Master" AutoEventWireup="true" CodeBehind="AfterLoginEmployee.aspx.cs" Inherits="CRM_Final_Project.AfterLoginEmployee" %>
                ...
                <ul class="list-unstyled topbar-menu float-end mb-0">
                    ...
                    <li class="dropdown notification-list">
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated topbar-dropdown-menu profile-dropdown">
                            ...
                            <!-- item-->
                            <a href="MyProfileForEmployee.aspx" class="dropdown-item notify-item">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title" style="font-style: italic; font-family: 'Times New Roman', Times, serif">Employee Dashboard</h4>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                            ...
                            <div class="col-lg-6">
                                <div class="card widget-flat">
                                    <div class="card-body">
                                        ...
                                        <h5 class="text-muted fw-normal mt-0" title="Total No of Reply on Complaint">Total No of Reply on Complaint</h5>
                            ...
                            <div class="col-lg-6">
                                <div class="card widget-flat">
                                    <div class="card-body">
                                        ...
                                        <h5 class="text-muted fw-normal mt-0" title="Total No of Reply on Query">Total No of Reply on Query</h5>
                                       
                                        <p class="mb-0 text-muted">
                                            <asp:Label ID="Label4" runat="server" Text="Label"></asp:Label><br />
                                            <span class="text-nowrap">Latest Updated</span>
                                        </p>
                                    </div>
                                    <!-- end card-body-->
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="card widget-flat">
                                    <div class="card-body">
                                        ...
                                        <h5 class="text-muted fw-normal mt-0" title="No of Under-Processing Query">No of Under-Processing Query</h5>
                            ...
                            <div class="col-lg-6">
                                <div class="card widget-flat">
                                    <div class="card-body">
                                        ...
                                        <h5 class="text-muted fw-normal mt-0" title="No of Under-Processing Complaint">No of Under-Processing Complaint</h5>
