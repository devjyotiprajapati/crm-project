    ...
    public partial class EmployeeLogin : System.Web.UI.Page
    {
        ...
        protected void bt1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Session["Empname"] = TextBox1.Text;//Globle variable Session for calling any where in project
                    Session["Emppass"] = TextBox2.Text;//Globle variable Session for calling any where in project
                    Response.Redirect("AfterLoginEmployee.aspx");//Open Home Page
                }
                else//If Unmatched
                {
                    Label1.Visible = true;
