<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerLogin.aspx.cs" Inherits="CRM_Final_Project.CustomerLogin" %>
        ...
        <div class="container-fluid bg">
            <div class="row">
                ...
                <div class="col-md-4 col-ms-4 col-xs-12  box"> 
                    <h1 class="text-center text-capitalize " >Customer LogIn</h1>
                    ...
                    <div class="form-group">
                        <asp:Button ID="Button1" runat="server" Text="Login" OnClick="Button1_Click"  class="btn btn-block btn-primary"/>
                    </div>
                 <div class="form-group">
                     <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="~/Newsignup.aspx">Create New User Account</asp:LinkButton>
                 </div>
