...
{
    public partial class AdminLgin : System.Web.UI.Page
    {
        ...
        protected void bt1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string qry = "select * from Admin where Name=@12 and Password=@21";//SQL Query
                ...
                {
                    Session["Adminname"] = TextBox1.Text;//Globle variable Session for calling any where in project
                    Session["Adminpass"] = TextBox2.Text;//Globle variable Session for calling any where in project
                    Response.Redirect("~/Admin/AdminHomeAfterLogin.aspx");//Open Home Page
                }
                else//If Unmatched
                {
                    Label1.Visible = true;
