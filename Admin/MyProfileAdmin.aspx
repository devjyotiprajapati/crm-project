<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Afterloginadmin.Master" AutoEventWireup="true" CodeBehind="MyProfileAdmin.aspx.cs" Inherits="CRM_Final_Project.Admin.MyProfileAdmin" %>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-ms-4 col-xs-12 box" >
                    ...
                    <div class="form-group">
                        <asp:Label ID="Label11" runat="server" Text="Label">Admin ID</asp:Label>
                    ...
                    <div>
                        ...
                        <asp:TextBox ID="TextBox6" runat="server" Class="form-control" ReadOnly="True"></asp:TextBox>
                                 ...
                                 <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="~/Admin/AdminHomeAfterLogin.aspx" ForeColor="White">Back</asp:LinkButton>      
