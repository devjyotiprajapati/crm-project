    ...
    public partial class ManageCustomer : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            try
            {
                ...
                string qry = "update Customer set Name=@t1,Age=@t2,Address=@t3,MobileNo=@t4,EmailId=@t5,DOB=@t6,Gender=@t7,DateofJoin=@t8 Where CustID=@t9";//SQL Query
                SqlCommand cmd = new SqlCommand(qry, con);//Send Query for execution
                ...
                string doj = ((TextBox)GridView1.Rows[e.RowIndex].Cells[9].Controls[0]).Text;
                ...
                cmd.Parameters.AddWithValue("@t8", doj);//Passing Paramiters to the Query
