<%@ Page Title="" Language="C#" MasterPageFile="~/AfterloginMasterPage.Master" AutoEventWireup="true" CodeBehind="ChangepasswordforCustomer.aspx.cs" Inherits="CRM_Final_Project.ChangepasswordforCustomer" %>
                ...
                <table class="auto-style1">
                    <tr>
                        <td class="auto-style2">
                            <asp:Image ID="Image1" runat="server" Height="122px" ImageUrl="~/Image/changepassword2.jpg" Width="270px" />
                        </td>
                        <td>
                            <table class="auto-style1">
                                <tr>
